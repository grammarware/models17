...
* The results of the transformation process is a UMLsec model  will be stored to the project root directory. The name of the UMLsec models is **Transformed_serialized_profile.uml**.
